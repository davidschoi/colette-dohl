    ...
    <>
      ...
      <main className="mx-auto max-w-[1960px] p-4">
        ...
        <div className="after:content relative flex h-[calc(100vh-2rem)] flex-col items-center justify-end gap-3 overflow-hidden rounded-lg bg-white/10 px-6 pb-16 pt-64 text-center text-black after:pointer-events-none after:absolute after:inset-0 after:rounded-lg lg:pt-0">
          <div className="absolute inset-0 flex items-center justify-center opacity-30">
            <span className="flex max-h-full max-w-full items-center justify-center">
              <Image
                ...
                alt="Colette's Dohl cover photo"
                width="1960"
                height="2832"
                priority
          ...
          <p className="max-w-[50ch] tracking-wide text-black sm:max-w-[40ch]">
            Thank you so much for celebrating Colette's first birthday with us. We are so grateful for your gift, words
            of love, and your presence on her special day. We hope you enjoy these photos!
          </p>
          <a
